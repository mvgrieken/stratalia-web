...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log(`🔔 Fetching notifications - User: ${userId}, Unread only: ${unreadOnly}, Limit: ${limit}`);
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(`🔔 Creating notification - User: ${user_id}, Type: ${notification_type}`);
...
export async function PUT(request: NextRequest) {
  try {
    ...
    console.log(`🔔 Marking notification as read - ID: ${notification_id}, User: ${user_id}`);
